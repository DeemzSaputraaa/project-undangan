...
export default function WeddingGift() {
  ...
  return (
    <section className="section" id="gift" style={{ padding: "clamp(40px, 8vw, 80px) 0", background: "url('/images/awal.jpg') center 35% / cover", position: "relative" }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ position: "absolute", bottom: "16px", right: "16px", zIndex: 3 }}>
                  <button 
                    ...
                    onMouseOver={(e) => e.target.style.background = "#848d98"}
                    onMouseOut={(e) => e.target.style.background = "#9aa3af"}
                  >
              ...
              <div style={{
                ...
                <div style={{ marginBottom: "0px", display: "flex", justifyContent: "center" }}>
                  <img src="/hadiah.svg" alt="Hadiah Icon" style={{ width: "32px", height: "32px", objectFit: "contain" }} />
                </div>
                
                <h3 style={{ fontFamily: "var(--font-heading), serif", fontSize: "clamp(1.1rem, 4vw, 1.3rem)", color: "#455061", margin: "4px 0 12px 0", fontWeight: "700" }}>
                  Kirim Hadiah
                </h3>
                
                <div style={{ color: "#444", fontSize: "clamp(0.7rem, 2.5vw, 0.9rem)", lineHeight: "1.6", fontWeight: "500", position: "relative", zIndex: 2 }}>
                  <div>Nama Penerima : Lukmaniati</div>
                  <div>No. HP : 081234567890</div>
                  <div>Alamat : Kediaman Mempelai Wanita</div>
                  <div>Ds Pagu, Wates, Kediri, Jawa Timur</div>
                </div>
              </div>
            </div>
          </div>
